        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('getAll')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('getOwners')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Car Owners</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('getPassengers')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Passengers</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item"> 
                <a href="{{ route('getRecentlyTrips')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Recently trips</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('getCurrentlyTrips')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Currently trips</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('getUpcomingTrips')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Upcoming trips</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{ route('getCars')}}" class="nav-link">
